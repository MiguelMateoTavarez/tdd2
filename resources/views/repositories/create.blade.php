        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                <form action="{{ route('repositories.store') }}" method="POST" class="max-w-md">
                    ...
                    <input class="form-input w-full rounded-md shadow-sm" type="text" name="url" id="">
                    ...
                    <input class="bg-blue-500 text-white font-bold py-2 px-4 rounded-md" type="submit" value="Guardar">
                </form>
            </div>
        </div>
    </div>
